...
public class HospitalMngtApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		doc1.setDocId(101);
		doc1.setDocName("Manisha");
		doc1.setDocAge(22);
		doc1.setDocEmail("manishasingh284@gmail.com");
		doc1.setDocMobile("9992301842");

		Doctor doc2 = new Doctor();
		doc2.setDocId(102);
		doc2.setDocName("Rubal");
		doc2.setDocAge(24);
		doc2.setDocEmail("rubalsingh@gmail.com");
		...
		doc4.setDocId(104);
		doc4.setDocName("preeti");
		doc4.setDocAge(25);
		doc4.setDocEmail("preeti@gmail.com");
